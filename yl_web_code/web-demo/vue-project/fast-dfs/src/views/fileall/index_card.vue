  ...
  <div style="height: 100%;">
    ...
    <el-row style="margin-top:-10px;margin-left: -20px;margin-right: -20px;">
      <el-col :span="18" class="nav">
        ...
        <!-- 新建文件夹按钮 -->
        <el-button type="text" icon="el-icon-folder-add" v-if="checkedcount==0">新建文件夹</el-button>
        <el-button type="text" icon="el-icon-folder-add" v-if="checkedcount>0" disabled>新建文件夹</el-button>
      ...
      <el-col :span="2" class="nav">
        <el-button type="text" icon="el-icon-tickets" @click="toggle()">卡片模式</el-button>
      </el-col>
    </el-row>
    <!--==================================链接导航==================================-->
    <el-row>
...
export default {
  ...
  methods: {
    ...
    toggle() {
      this.$router.push("/index/fileall/list");
    },
    findList() {
      this.loading = true;
      this.$http
