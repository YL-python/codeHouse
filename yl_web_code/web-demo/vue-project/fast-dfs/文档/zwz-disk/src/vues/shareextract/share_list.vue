  ...
  <div style="height: 100%;background: #F2F6FC;">
    <el-container style="height: 100%;">
      <el-header class="header">
        ...
        <el-link type="success" class="topright" v-if="nickname!=''&&nickname!=null">
          ...
          <div slot="header" class="clearfix">
            <p style="line-height: 40px;">
              ...
              <el-button
                ...
                size="small"
                style="float: right;"
                v-if="nickname!=''&&nickname!=null&&checkedcount==0"
                disabled
              >转存网盘</el-button>
              <el-button
                type="primary"
            ...
            >
              ...
              <el-table-column prop="icon" label="文件名">
                <template slot-scope="scope">
                  ...
                  <span
                    class="link"
                    @click="itemClickEnter(scope.row.id,scope.row.filename,scope.row.filetype)"
...
export default {
  ...
  methods: {
    findOne() {
      this.loading = true;
      this.$http
        .post("disk/shareextract/findShareInfo", {
          id: this.id
        })
        .then(response => {
    ...
    findList() {
      this.loading = true;
      this.$http
        .post("disk/shareextract/findShareList", {
          id: this.id,
          pid: this.pid,
