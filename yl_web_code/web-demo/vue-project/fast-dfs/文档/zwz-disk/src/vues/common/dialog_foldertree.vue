          ...
          >
            <el-table-column prop="filename" label="文件名">
              <template slot-scope="scope">
                ...
                <span
                  class="link"
                  @click="itemClickEnter(scope.row.rowindex)"
...
export default {
  ...
  methods: {
    ...
    findList() {
      this.loading = true;
      this.$http
        .post("disk/filecommon/findFolderList", {
          pid: this.search.pid,
          idjson: "",
    ...
    saveFileFromShare() {
      ...
      this.$confirm(
        ...
        this.loading = true;
        this.$http
          .post("disk/shareextract/saveFromShare", {
