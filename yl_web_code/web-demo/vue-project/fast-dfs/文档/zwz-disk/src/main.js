...
var router = new VueRouter({
	routes: [{
...

		{
			...
			children: [{
					path: '/main',
					redirect: 'fileall/index'
				},
				{
					path: "filehistory/index",
					component: filehistoryindex
				},
				{
					path: "fileall/index",
					component: fileallindex
				},
				{
					path: "fileall/indexcard",
					component: fileallindexcard
				},
				{
					path: "filedocument/index",
					component: filedocumentindex
				},
				{
					path: "filepicture/index",
					component: filepictureindex,
					children: [{
							path: '/main/filepicture/index',
							redirect: 'album'
						},
						{
							path: "album",
							component: filepictureindexalbum
						},
						{
							path: "albumfile",
							component: filepictureindexalbumfile
						},
						{
							path: "file",
							component: filepictureindexfile
						}
					]
				},
				{
					path: "filevideo/index",
					component: filevideoindex
				},
				{
					path: "filemusic/index",
					component: filemusicindex
				},
				{
					path: "fileother/index",
					component: fileotherindex
				},
				{
					path: "sharebyself/index",
					component: sharebyselfindex
				},
				{
					path: "sharebyfriends/index",
					component: sharebyfriendsindex
				},
				{
					path: "rubbish/index",
					component: rubbishindex
				},
				{
					path: "search/index",
		...
		},
		{
			...
			children: [{
				...
				},
				{
					...
					component: create_markdown
				},
				{
					path: "create_ppt",
					component: create_ppt
				},
				{
					path: "create_text",
				...
				{
					path: "preview_markdown",
					component: preview_markdown
				},
				{
					path: "preview_office",
					component: preview_office
				},
				{
					path: "preview_pdf",
