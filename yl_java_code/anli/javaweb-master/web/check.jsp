...
//执行查询
    String sql1 = "select * from sc where qiandao='是'";
//    String sql1 = "select sc.*,coursetable.*FROM sc,coursetable WHERE sc.course=coursetable.name AND sc.qiandao='是'";
