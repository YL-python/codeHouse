...
//执行查询
    String sql1 = "select * from sc where qiandao='否'";
//    String sql1 = "select sc.*,coursetable.*FROM sc,coursetable WHERE sc.course=coursetable.name AND sc.qiandao='否'";
    ...
    <ul id="accordion" class="accordion">
        <li>
            ...
            <ul class="submenu">
                ...
                <li><a href="showalllist.jsp">显示全部学生名单</a></li>
            </ul>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <form action="/ShowlistServlet" method="post">
                            ...
                            </td>    <input type="hidden" name="xingqi" value="<%=rs.getString("xingqi1") %>"/>
                            <td><%=rs.getString("jie1") %>
                            </td>    <input type="hidden" name="jie" value="<%=rs.getString("jie1") %>"/>
