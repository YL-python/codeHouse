...
public class demo15_工具栏01 {
    public static void main(String[] args) {
        ...
        JButton b2 = new JButton(new ImageIcon("D:\\Intellij_IDEA\\mySwing\\src\\main\\java\\Swing\\gareen.jpg"));
        JButton b3 = new JButton(new ImageIcon("D:\\Intellij_IDEA\\mySwing\\src\\main\\java\\Swing\\gareen.jpg"));
        JButton b4 = new JButton(new ImageIcon("D:\\Intellij_IDEA\\mySwing\\src\\main\\java\\Swing\\gareen.jpg"));
        JButton b5 = new JButton(new ImageIcon("D:\\Intellij_IDEA\\mySwing\\src\\main\\java\\Swing\\gareen.jpg"));
        JButton b6 = new JButton(new ImageIcon("D:\\Intellij_IDEA\\mySwing\\src\\main\\java\\Swing\\gareen.jpg"));
        tb.add(b1);
        tb.add(b2);
        tb.add(b3);
        tb.add(b4);
