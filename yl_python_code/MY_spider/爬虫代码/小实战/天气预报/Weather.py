    ...
    def print_data(self):
        ...
        for i in range(7):
            ...
            print('|{x:^{y}s}\t'.format(x=self.weather_list[i],
                                        y=14 - len(self.weather_list[i].encode('GBK')) + len(self.weather_list[i])), end='')
            # print(self.temperature_list[i].rjust(10),end='')
            print('|{x:^{y}s}\t'.format(x=self.temperature_list[i],
                                        y=14 - len(self.temperature_list[i].encode('GBK')) + len(self.temperature_list[i])), end='')
