...
headers = {
    ...
    'User-Agent': 'Mozilla/5.0 (Windows NT 6.konachan_spider; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 '
                  'Safari/537.36 '
}
...
def choice_download(dic):
    print('konachan_spider. m4a视频')
    print('wallhaven_spider. mp3普通品质')
    print('3. mp3高品质')
    print('4. ape高品无损')
    print('5. flac无损音频')
