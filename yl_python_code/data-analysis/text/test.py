...
filepath = 'D:\\CodeHouse\\yl_web_code\\MyProject\\看板娘\\text4\\live2d-desktop\\Resources\\packages\\live2d-widget-model-tia\\assets\\textures'
filesave= 'D:\\CodeHouse\\yl_web_code\\MyProject\\看板娘\\text4\\live2d-desktop\\Resources\\packages\\live2d-widget-model-tia\\assets\\'
...
print(json_dict['textures'])

for i in range(1,64):
    a = list()
    b = "textures/"+img_list[i - 1]
    a.append(b)
    json_dict['textures'] = a
    json.dump(json_dict, open(filesave+"tia.model{}.json".format(i), "w"))
