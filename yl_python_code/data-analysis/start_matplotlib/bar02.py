...
plt.barh( range( len(a)), b,height=0.3,color='cyan')    # barh()

plt.title('票房对比',fontproperties=my_font2)
plt.ylabel('影片',fontproperties=my_font2)
plt.xlabel('票房（亿）',fontproperties=my_font2)

plt.yticks(range(len(a)), a,fontproperties=my_font1)
